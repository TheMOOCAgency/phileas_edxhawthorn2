...
class TmaCourseOverviewAdmin(admin.ModelAdmin):
    list_display = ('course_overview_edx','is_manager_only','is_mandatory','is_vodeclic','liked_total','favourite_total','is_course_graded','active_enrollments_total')
    fields=('course_overview_edx','is_manager_only','is_mandatory','is_vodeclic','liked_total','favourite_total','is_course_graded','active_enrollments_total')
