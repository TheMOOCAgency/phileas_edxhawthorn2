...
class TmaCourseOverviewAdmin(admin.ModelAdmin):
    list_display = ('course_overview_edx','is_manager_only','is_mandatory','is_new','has_menu', 'is_linear', 'liked_total','favourite_total','is_course_graded','active_enrollments_total','tag', 'onboarding', 'course_about')
    fields=('course_overview_edx','is_manager_only','is_mandatory', 'is_new','has_menu','is_linear','liked_total','favourite_total','is_course_graded','active_enrollments_total','tag', 'onboarding', 'course_about')
