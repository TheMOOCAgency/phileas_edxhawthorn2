...
function isUnitAvailable(currentUnit) {
  ...
  if (
    ...
    $(".overlay-button-next").qtip({
      content: {
        text:
          gettext("You cannot access the next unit because the current unit is not completed.")+" "+gettext("Please ensure that you viewed all contents and answered all questions.")+" "+gettext("A blue border appears on uncompleted blocks.")
      },
      position: {
        my: "top right",
        at: "bottom right"
